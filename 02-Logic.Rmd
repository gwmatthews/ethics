...
- Are the claims that we started from, our premises, really true? In philosophical terminology: **is it sound**?
 ...
 `r margin_note("SOUNDNESS: A sound argument is a valid argument that also has TRUE premises.")`
