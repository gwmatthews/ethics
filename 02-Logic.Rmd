...
![](img/tenniel-tweedle-dee-dum.jpg){width=50%}
...
## Further exploration {- #further-2}


- For the slideshow summarizing the main points of this chapter, [click here](https://gwmatthews.github.io/ethics-slideshows/02-logic.html).
...
- For a slightly different and more in-depth treatment of the basic concepts of logic see [the logic chapter](https://jonathanweisberg.org/vip/logic.html#logic) of Jonathan Weisberg's open source textbook on probability and statistics, *Odds & Ends.* 

- Wireless Philosophy is a well-produced series of short videos on a great many topics in philosophy. Their [playlist on Logic and Critical Thinking](https://www.youtube.com/playlist?list=PLtKNX4SfKpzX_bhh4LOEWEGy3pkLmFDmk) is a great resource for exploring logical thinking in all of its complexity, 5 or 6 minutes at a time.
