...
**_A philosophical approach_** to ethics, or moral philosophy^[Throughout this book I'll be using the terms "ethics" and "morality" as basically synonymous. Some people distinguish between the two terms in one way or another and that is fine as far as it goes. But since the reason English has both terms is that we borrowed each from a different language -- "ethics" comes from Greek, while "morality" comes from Latin -- and both original terms mean something pretty similar, I see no reason to insist on any fundamental different meaning between them.], is concerned with a number of different kinds of questions. Thus the broader field of ethics can be divided up into a number of different sub-fields. These are:
...
**_Descriptive ethics_** is not exclusively a philosophical approach to ethics in that sociologists, psychologists, anthropologists and other social scientists may also be concerned with people's ethical beliefs. This approach looks at our beliefs about ethical issues and about ethics in general as facts about us to be cataloged and explained.
