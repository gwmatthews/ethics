...
Icons are by Paul Davey aka [Mattahan](href="http://mattahan.deviantart.com). All rights reserved.
...
- offer editorial suggestions (see below for how this works).
...
To use this system you will have to enter a valid email address and then click on a link in the email this system sends you and whatever comments you make will be stored on the Remarkbox servers. You can see exactly what they store by reading their [privacy policy](https://www.remarkbox.com/privacy-policy.html).
...
1. Type your comment in the window -- you can format it using markdown or just write in plain text.
...
1. Leave a comment and we can discuss possible changes.
2. Click on the "edit" button on the top menu bar -- this will take you to the GitHub repository where the source material lives. There you can either open up an "issue" and we can discuss it there, or you can "fork" the repository make whatever edits you want and then offer them in the form of a "pull request." All of this assumes that you:
  1. know what "git" even is -- it is a version control system that enables collaboration and it mostly intended for software development, but it can be used for working together on any kind of project that involves electronic files, from novels to operating systems.
    - Here is a great introduction to git (oriented towards users of Rstudio which is what this book was written with:[Happy Git and GitHub for the useR](https://happygitwithr.com/)
    - and a very clear and well done interactive tutorial (this one is oriented towards Bitbucket not GitHub, but it's great for understanding how to use git)[Learn git with Bitbucket Cloud](https://www.atlassian.com/git/tutorials/learn-git-with-bitbucket-cloud)
  2. have an account at GitHub -- which is free. And GitHub pages is a great way to get yourself a free website too!
3. Send me an email if you know me in the real world.
