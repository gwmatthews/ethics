...
Here is the slideshow summary covering the main points of this chapter.

## Further exploration {-}

```{r, fig.align = 'center', echo = FALSE }
knitr::include_graphics('img/further.png')
```

**_Relativism is_** a challenging position to take about ethics. It challenges its defenders to come up with an argument in favor of it that doesn't either beg the question, or undermine itself. 
