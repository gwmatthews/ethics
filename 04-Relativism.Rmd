...
If relativism shuts down debate with its assertion that we can never get beyond individual perspectives to any kind of moral common ground, our arguments against relativism put the burden squarely on us. If there is such moral common ground we have to learn to talk to each other about that, since it is only in being articulated as common ground that it actually exists. This project called "A Starting Point" is an attempt to open up dialogue through mutual understanding across the political divides that we find ourselves torn by.
...
```{asis, echo=identical(knitr:::pandoc_to(), 'html')}
  ...
  <div>
  <a href="https://www.astartingpoint.com/">A Starting Point</a>
  </div>
...
<div class="video">
  <iframe src="https://www.youtube.com/embed/FOoffXFpAlU" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
</div>
