...
**_But relativism also_** presents a challenge to its opponents since it honestly acknowledges how firmly we cling to our sense of what is right and what is wrong. People **do** tend to dig in and refuse to either accept reasons against their own favored views or even the possibility of compromise. In spite of this, however, radical changes of viewpoint as a result of reflection on one's own values are possible. See the links below for some examples. What these show, it seems to me at least, is that it does make sense to look at values as amenable to rational reflection and justfication. We will look at some different ideas about what this involves in the third part of this book. Before we get there, we will need to open up two more cans of worms -- the view that the only way to provide a solid backing for value judgments is if they are based on some kind of absolute authority ([chapter 5](#religion)); and the view that value judgments either are or should be essentially self-serving ([chapter 6](#egoism)).

## Further exploration {-}

- Soon there will be a link here to the slideshow summary covering the main points of this chapter.

- Tom Green's Crash course series on philosophy offers great summaries of the major questions dealt with by philosophers. You may find his video on [Metaethics](https://youtu.be/FOoffXFpAlU) helpful in ciming to terms with the strengths and weaknesses of moral relativism.

- Conversion by Twitter

- The Case of Derek Black
