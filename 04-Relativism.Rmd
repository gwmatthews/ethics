...
**_A second way to argue_** that relativism is true is to appeal to the origins of our ideas of moral concepts. It seems plausible that we get our ideas about what is right and what is wrong by learning them from those around us. We may have certain built-in reflexes but moral judgments are learned and are not innate. This is a commonly held view on morality -- the apple doesn't fall far from the tree, so if a child is raised with strict moral guidelines, she will be better behaved than a child given too much freedom to choose. We will get back to the question of whether or not this is really the best way to look at morality in a moment. For now we can grant it as the premise for a second argument in defense of relativism.
