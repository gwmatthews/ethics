...
\href{https://youtu.be/_gVyEOefhIQ}{Socrates on self-confidence} and questioning others about their values. A great video outlining the motivation for doing philosophy in the first place.

\href{https://qz.com/1327804/its-impossible-to-lead-a-totally-ethical-life-but-its-fun-to-try/}{It's impossible to lead a totally ethical life}: Ephrat Livni reflects on ethics and everyday life.
...
\tightlist
\item
  Have good reasons for what you believe. Don't just repeat them because you have heard them, but own them because you have thought them through and they seem to present a defensible picture of how things should be. (This is what VALID reasoning is all about.)
\item
  Adjust your theories to the evidence. Theories are nothing but models that help us see what might happen next. If our theories keep telling us that something will happen and it doesn't so much the worse for the theory. (This is discussed below under SOUNDNESS.)
\end{enumerate}
