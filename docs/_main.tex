...
\addcontentsline{toc}{subsection}{Cultural differences}
...
\addcontentsline{toc}{subsection}{A counterexample}
...
\addcontentsline{toc}{subsection}{learning right from wrong}
...
\newthought{In fact} we could take this point further and point out that all human cultures share certain basic values. We all:
