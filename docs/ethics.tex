...
\item
  ...
  threads you like.
\item
  If you get stuck with your profile open, you can use the back button
  or your browser or refresh the page. (Seems like a bug to me,
  honestly, but this is software in active development.)
\end{enumerate}
\end{rmdimportant}
