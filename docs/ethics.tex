...
Icons are by Paul Davey aka \href{href=\%22http://mattahan.deviantart.com}{Mattahan}. All rights reserved.
...
\item
  know what ``git'' even is -- it is a version control system that enables collaboration and it mostly intended for software development, but it can be used for working together on any kind of project that involves electronic files, from novels to operating systems. - Here is a great introduction to git (oriented towards users of Rstudio which is what this book was written with:\href{https://happygitwithr.com/}{Happy Git and GitHub for the useR} - and a very clear and well done interactive tutorial (this one is oriented towards Bitbucket not GitHub, but it's great for understanding how to use git)\href{https://www.atlassian.com/git/tutorials/learn-git-with-bitbucket-cloud}{Learn git with Bitbucket Cloud}
\item
...
\begin{center}\includegraphics[width=0.43in]{img/task} \end{center}
...
\begin{center}\includegraphics[width=0.4\linewidth]{img/illusion} \end{center}
...
\begin{center}\includegraphics[width=0.43in]{img/further} \end{center}
