...
If you are a current student in one of my Ethics classes you'll have to do some commenting. When I used WordPress to host this text that was a built in feature. Here I am relying on a third party commenting add-on to the online version of the book. There are many ways to do this, with Disqus being one of the most popular. But we won't be using that since they track users and push lots of severtising. Instead we'll be using a nice tool called Hypothes.is, which \protect\hyperlink{appendix-1}{you can find out all about here}.

Others are also welcome to comment on the text. If you are a GitHub user and you like to contribute you can use the comment boxes at the end of each chapter to make suggestions or add editorial comments.
...
\item
  Finally there is a special kind of bookmark that you can save for use in your browser. That creates a link that you can just click anytime you want to take notes on a page you are reading. If you don't use Chrome this will be what you want.
\item
...
\item
  Then you can join the private group \href{mailto:Ethics@PCT}{\nolinkurl{Ethics@PCT}} and add a note to this page. To join, follow the link I sent you after you have registered.
\end{itemize}
...
Your first assignment is to add a group note to this page that will be visible only to the \href{mailto:Ethics@PCT}{\nolinkurl{Ethics@PCT}} group.
...
\hypertarget{step-one-login}{%
\paragraph{step one, login}\label{step-one-login}}
\addcontentsline{toc}{paragraph}{step one, login}

Most likely this will automatically fill in your ID and password. If not consult your memory.

\hypertarget{step-two-pick-the-right-group}{%
\paragraph{step two, pick the right group}\label{step-two-pick-the-right-group}}
\addcontentsline{toc}{paragraph}{step two, pick the right group}

On the top edge of the tool click the drop-down menu that says ``Public'' and then switch that to the right group. (You can organize your other annotations for other classes by creating a new private group with only you as a member and post to that group.)

\hypertarget{step-three-highlight-some-text}{%
\paragraph{step three, highlight some text}\label{step-three-highlight-some-text}}
\addcontentsline{toc}{paragraph}{step three, highlight some text}

Use your mouse or touch screen to select some text by clicking and dragging over it. If Hypothes.is is active you'll see the text highlighted in blue with two choices below, ``highlight'' and ``add note.'' Select ``add note.''

\hypertarget{step-four-write-a-note}{%
\paragraph{step four, write a note}\label{step-four-write-a-note}}
\addcontentsline{toc}{paragraph}{step four, write a note}

Write what you want, but do recognize that all of us in this course will be able to read it. Write in complete sentences and write clearly!

\hypertarget{step-five-add-the-tag-assignment-one}{%
\paragraph{step five, add the tag ``assignment one''}\label{step-five-add-the-tag-assignment-one}}
\addcontentsline{toc}{paragraph}{step five, add the tag ``assignment one''}

To complete this assignment, you'll need to add this exact tag. To add a tag just type words in the tags box, no /\# sign needed. Spaces are allowed, hit enter to complete tag. I highly recommend tagging all notes so you can find them later.

\hypertarget{step-six-save-note-to-group}{%
\paragraph{step six, save note to group}\label{step-six-save-note-to-group}}
\addcontentsline{toc}{paragraph}{step six, save note to group}

This makes your note visible to everyone in the group and nobody else. Everyone in the group will be able to respond to this note as well.

\hypertarget{step-seven-go-to-your-hypothes.is-page-to-verify-that-you-did-it-right}{%
\paragraph{step seven, go to your Hypothes.is page to verify that you did it right}\label{step-seven-go-to-your-hypothes.is-page-to-verify-that-you-did-it-right}}
\addcontentsline{toc}{paragraph}{step seven, go to your Hypothes.is page to verify that you did it right}

Not strictly necessary for other note taking, but do this now so you can see what's there. This is your collection of notes which can be filtered by tags, groups, etc. To find all your notes for this course or see what other people have said in the group, this is where to go.

\hypertarget{references}{%
\chapter*{References}\label{references}}


\hypertarget{editorial-comments}{%
