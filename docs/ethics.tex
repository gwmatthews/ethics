...
\newenvironment{centertop}{\begin{center}}{\end{center}}
\usepackage[]{natbib}
...
\begin{center}\includegraphics[width=0.5\linewidth]{img/hongzhi} \end{center}
...
\begin{center}\includegraphics[width=0.43in]{img/tux} \end{center}
...
\begin{center}\includegraphics[width=0.6\linewidth]{img/david-socrates} \end{center}

\end{centertop}

\begin{center}

\begin{FVerbatim}[fontsize=\footnotesize, fontfamily=helvetica]
...
\item
  What are the differences between ethical claims and claims about the
  facts?
\end{itemize}
\end{rmdquestion}
...
\tightlist
\item
  What is the right thing to do in real-world cases of ethical
  controversy?
\item
  What assumptions and principles lie at the basis of ethical
  controversies?
\end{itemize}
\end{rmdquestion}
...
convinced as well. I have really good evidence for this claim.
\end{argument}
...
\begin{center}\includegraphics[width=0.6\linewidth]{img/illusion} \end{center}
...
\href{https://pixabay.com/users/OpenClipart-Vectors-30363}{OpenClipart-Vectors} at \href{https://pixabay.com/}{Pixabay}
...
\begin{center}\includegraphics[width=0.5\linewidth]{img/buddha-bird} \end{center}
...
\href{https://pixabay.com/users/mikhsan-4911734/}{mikhsan} at \href{https://pixabay.com/}{Pixabay}
...
\begin{center}\includegraphics[width=0.5\linewidth]{img/tori-shrine} \end{center}
...
\href{https://pixabay.com/users/jordymeow-943760/}{JordyMeow} at \href{https://pixabay.com/}{Pixabay}
...
\begin{center}\includegraphics[width=0.5\linewidth]{img/hardcore-02} \end{center}
...
\href{https://www.dreadscott.net/}{Dread Scott}, Hardcore series, ``Devin''
...
but---my food, even as I too am fed upon and turned to use by you.
