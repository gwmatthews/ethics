...
---Ruth Benedict, Patterns of Culture\footnote{Benedict}
...
\tightlist
\item
  \emph{Violating the laws of nature is wrong.} This is clearly false in that the laws of nature are just descriptions of regularities in nature and so it makes no sense to talk about violating them. Apparent violations of the law really just show us that we described things incorrectly.
\item
  \emph{What is uncommon is wrong.} Obviously not always -- being part of the statistically defined norm is neither good not bad by itself. Rare talents are great, rare diseases not so good.
\item
  \emph{What is artificial is wrong.} While we might resist buying food labelled ``All artificial ingredients,'' and assume that natural ingredients are better than artificial ones, this claim is not in general true. There are plenty of things like artificial heart valves and limbs that have made people's lives better and many perfectly natural phenomena like tornados and earthquakes that have not.
\item
...
Benedict, Ruth. \emph{Patterns of Culture}. Houghton Mifflin, 1935.

\leavevmode\hypertarget{ref-davisWouldYouPull2015}{}%
Davis, Lauren Cassani. ``Would You Pull the Trolley Switch? Does It Matter?'' \emph{The Atlantic}, 2015, \url{https://www.theatlantic.com/technology/archive/2015/10/trolley-problem-history-psychology-morality-driverless-cars/409732/}.

\leavevmode\hypertarget{ref-gelmanEssentialismEverydayThought}{}%
Gelman, Susan. ``Essentialism in Everyday Thought.'' \emph{American Psychological Association}, \url{https://www.apa.org/science/about/psa/2005/05/gelman}. Accessed 13 Dec. 2019.
...
Lent, Jeremy. \emph{The Patterning Instinct}. Prometheus Books, 2017.

\leavevmode\hypertarget{ref-prestonMooreGeorgeEdward}{}%
Preston, Aaron. ``Moore, George Edward.'' \emph{Internet Encyclopedia of Philosophy}, \url{https://www.iep.utm.edu/moore/}. Accessed 13 Dec. 2019.
