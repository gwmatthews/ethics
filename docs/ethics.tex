...
\textbf{\emph{Then in the succeeding chapters}} we will look briefly at a number of topics in applied ethics in the light of the various theories we have been examining. It turns out that under the surface of many debates in applied ethics there are competing ethical theories and commitments. What makes these debates debates about ethics, and not policy debates about the pros and cons of some topic or other is that both sides appeal to something that seems like it has a legitimate moral claim to our allegiance.

\hypertarget{virtue-ethics-reconsidered}{%
\section{Virtue ethics reconsidered}\label{virtue-ethics-reconsidered}}

\textbf{\emph{We first encountered virtue ethics}} in the context of our discussion of Natural Law Theory, although its roots go much further back historically than the work of Thomas Aquinas whose ideas we focused on there. They go back especialy to the work of Aristotle. For Aristotle humans are not only ``rational animals'' but perhaps even more crucially ``political animals.'' We live together in society and it is only in the context of our social relations that it makes any sense at all to speak of ethics. Unlike relativists, though, Aristotle doesn't take this to mean that society \emph{defines} right and wrong by taking ultimately arbitrary cultural norms and elevating them to the status of moral principles. What he means has more to do with understanding what it is to be a ``good person'' in the sense of one who exhibits good judgment and what he calls ``practical wisdom.'' A good, or ``virtuous'' person\footnote{Aristotle uses the word ``\emph{arete}'' which is often translated as ``virtue'' but this is an imperfect translation. Perhaps a better way to translate ``\emph{arete}'' is with ``excellence'' or ``skill'' not in the sense of technical ability, but in the sense of having cultivated to a high degree the ``softer'' skills of good judgment, self-control and mastery of one's own life.} is someone who is good at making ``judgment calls'' or at finding his or her way through difficult decisions with poise and balance.

\hypertarget{application-to-moral-dilemmas}{%
\subsection*{Application to moral dilemmas}\label{application-to-moral-dilemmas}}


\hypertarget{ethics-in-community-modern-communitarianism}{%
\subsection*{Ethics in community: modern communitarianism}\label{ethics-in-community-modern-communitarianism}}


\hypertarget{feminism-gender-and-ethics}{%
\section{Feminism, gender and ethics}\label{feminism-gender-and-ethics}}

\hypertarget{in-a-different-voice}{%
\subsection*{In a different voice?}\label{in-a-different-voice}}


\hypertarget{feminisms-three-waves}{%
\subsection*{Feminism's three waves}\label{feminisms-three-waves}}


\hypertarget{zen-practice-realizing-ethics}{%
\section{Zen practice -- realizing ethics}\label{zen-practice-realizing-ethics}}

\hypertarget{some-background-on-buddhism}{%
\subsection*{Some background on Buddhism}\label{some-background-on-buddhism}}


\hypertarget{saving-all-sentient-beings}{%
\subsection*{Saving all sentient beings}\label{saving-all-sentient-beings}}


\hypertarget{practice-practice}{%
\subsection*{Practice, practice}\label{practice-practice}}
