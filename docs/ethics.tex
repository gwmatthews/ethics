...
\textbf{\emph{Step one, login:}} Most likely this will automatically fill in your ID and password. If not consult your memory.

\textbf{\emph{Step two, pick the right group:}} On the top edge of the tool click the drop-down menu that says ``Public'' and then switch that to the right group. (You can organize your other annotations for other classes by creating a new private group with only you as a member and post to that group.)

\textbf{\emph{Step three, highlight some text:}} Use your mouse or touch screen to select some text by clicking and dragging over it. If Hypothes.is is active you'll see the text highlighted in blue with two choices below, ``highlight'' and ``add note.'' Select ``add note.''

\textbf{\emph{Step four, write a note:}} Write what you want, but do recognize that all of us in this course will be able to read it. Write in complete sentences and write clearly!

\textbf{\emph{Step five, add the tag ``assignment one'':}} To complete this assignment, you'll need to add this exact tag. To add a tag just type words in the tags box, no /\# sign needed. Spaces are allowed, hit enter to complete tag. I highly recommend tagging all notes so you can find them later.

\textbf{\emph{Step six, save note to group:}} This makes your note visible to everyone in the group and nobody else. Everyone in the group will be able to respond to this note as well.

\textbf{\emph{Step seven, go to your Hypothes.is page to verify that you did it right:}} Not strictly necessary for other note taking, but do this now so you can see what's there. This is your collection of notes which can be filtered by tags, groups, etc. To find all your notes for this course or see what other people have said in the group, this is where to go.
