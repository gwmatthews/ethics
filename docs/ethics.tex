...
\usepackage{etoolbox}
\AtBeginEnvironment{centerbot}{\scriptsize}
...
\newenvironment{centerbot}{\begin{center}}{\end{center}}
\usepackage[]{natbib}
...
\begin{epigraph}
Two things fill the mind with ever-increasing wonder and awe, the more
