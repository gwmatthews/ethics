...
**_Step one, login:_** Most likely this will automatically fill in your ID and password. If not consult your memory.


**_Step two,  pick the right group:_** On the top edge of the tool click the drop-down menu that says "Public" and then switch that to the right group. (You can organize your other annotations for other classes by creating a new private group with only you as a member and post to that group.)


**_Step three,  highlight some text:_** Use your mouse or touch screen to select some text by clicking and dragging over it. If Hypothes.is is active you'll see the text highlighted in blue with two choices below, "highlight" and "add note." Select "add note."


**_Step four, write a note:_** Write what you want, but do recognize that all of us in this course will be able to read it. Write in complete sentences and write clearly!


**_Step five, add the tag "assignment one":_** To complete this assignment, you'll need to add this exact tag. To add a tag just type words in the tags box, no /# sign needed. Spaces are allowed, hit enter to complete tag. I highly recommend tagging all notes so you can find them later. 


**_Step six, save note to group:_** This makes  your note visible to everyone in the group and nobody else. Everyone in the group will be able to respond to this note as well.
