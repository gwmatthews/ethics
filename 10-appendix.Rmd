...
##### step three, highlight some text {-}
...
##### step five, add the tag "assignment one" {-}
...
##### step seven, go to your Hypothes.is page to verify that you did it right {-}
