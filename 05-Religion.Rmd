...
:::{.slideshow  data-latex="Here is a slideshow summary which can be \href{https://gwmatthews.github.io/ethics-slideshows/05-slides.html}{viewed online}, \href{https://gwmatthews.github.io/ethics-slideshows/pdf/05-slides.pdf}{downloaded} or \href{https://gwmatthews.github.io/ethics-slideshows/pdf/05-handout.pdf}{printed}."}
<iframe src="https://gwmatthews.github.io/ethics-slideshows/05-slides.html" width="100%">
</iframe>
:::

```{asis, echo=identical(knitr:::pandoc_to(), 'html')}

- [Download slides](https://gwmatthews.github.io/ethics-slideshows/pdf/05-slides.pdf) or [print them](https://gwmatthews.github.io/ethics-slideshows/pdf/05-handout.pdf).

```

## Further exploration {-}

- The Crash Course videos on [Divine Command Theory](https://youtu.be/wRHBwxC8b8I){target="_blank"} and [Natural Law Theory](https://youtu.be/r_UfYY7aWKo){target="_blank"} are both helpful accounts of the basic contours of these approaches to ethics.
