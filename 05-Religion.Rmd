...
1. *Violating the laws of nature is wrong.* This is clearly false in that the laws of nature are just descriptions of regularities in nature and so it makes no sense to talk about violating them. Apparent violations of the law really just show us that we described things incorrectly.
2. *What is uncommon is wrong.* Obviously not always -- being part of the statistically defined norm is neither good not bad by itself. Rare talents are great, rare diseases not so good.
3. *What is artificial is wrong.* While we might resist buying food labelled "All artificial ingredients," and assume that natural ingredients are better than artificial ones, this claim is not in general true. There are plenty of things like artificial heart valves and limbs that have made people's lives better and many perfectly natural phenomena like tornados and earthquakes that have not.
